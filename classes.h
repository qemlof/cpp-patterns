...
protected:
    ...
    string pet_name;
    int age;
    const string ab1 = "ѕервым, чему научилс€ этот питомец, было ";
    const string ab2 = "¬торым, чему научилс€ этот питомец, было  ";
    const string ab3 = "“ретьим, чему научилс€ этот питомец, было ";
public:
    Animal() {
        pet_id = ++static_id;
        pet_name = "";
...
public:
    ...
    void ability_1() override {
        cout << this->ab1 << "м€укать." << endl;
    }
    void ability_2() override {
        cout << this->ab2 << "лежать на колен€х хоз€ина." << endl;
    }
    void ability_3() override {
        cout << this->ab3 << "самосто€тельно гул€ть по улице." << endl;
    }
...
public:
    ...
    void ability_1() override {
        cout << this->ab1 << "ла€ть на незнакомцев." << endl;
    }
    void ability_2() override {
        cout << this->ab2 << "команда \"—идеть\"." << endl;
    }
    void ability_3() override {
        cout << this->ab3 << "команда \"ƒай лапу\"." << endl;
    }
...
public:
    ...
    void ability_1() override {
        cout << this->ab1 << "чистить перь€." << endl;
    }
    void ability_2() override {
        cout << this->ab2 << "чирикать." << endl;
    }
    void ability_3() override {
        cout << this->ab3 << "повтор€ть слова за хоз€ином." << endl;
    }
...
public:
    ...
    void ability_2() override {
        cout << this->ab2 << "пр€тать еду за щЄки." << endl;
    }
    void ability_3() override {
